...
func (_m *DrainManager) ScheduleNodesDrain(ctx context.Context, drainConfig *drainercordoner.DrainConfiguration) error {
	ret := _m.Called(ctx, drainConfig)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *drainercordoner.DrainConfiguration) error); ok {
